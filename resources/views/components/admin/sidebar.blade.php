                    ...
                    <ul class="menu">
                        ...
                        <li class="sidebar-item  has-sub">
                            ...
                            <ul class="submenu ">
                                ...
                                <li class="submenu-item ">
                                    <a href="{{ route('user.peminjaman') }}">Data Penerbit</a>
                                </li>
                                <li class="submenu-item ">
                                    <a href="{{ route('user.peminjaman') }}">Administrator</a>
                                </li>
                                <li class="submenu-item ">
                                    <a href="{{ route('user.peminjaman') }}">Data Peminjaman</a>
                                </li>
                            </ul>
                        </li>
                        ...
                        <li class="sidebar-item  has-sub">
                            ...
                            <ul class="submenu ">
                                ...
                                <li class="submenu-item {{ request()->is('pengembalian*') ? 'active' : '' }}">
                                    <a href={{ route('user.form_pengembalian') }}>Data Buku</a>
                                </li>

                                <li class="submenu-item ">
                                    <a href={{ route('user.pengembalian') }}>Kategori Buku</a>
                                </li>
                            </ul>
                        </li>
