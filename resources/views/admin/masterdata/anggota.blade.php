            ...
            <div class="card-body">
                ...
                {{-- @foreach ($anggota as $a)
                    <div class="modal fade" id="delete-masuk{{ $a->id }}" tabindex="-1"
                        ...
                        <div class="modal-dialog">
                            <div class="modal-content">
                                <form action={{ url('/delete/anggota/' . $a->id) }} method="POST"
                ...
                @foreach ($anggota as $a)
                    <div class="modal fade modal-borderless" id="hapus-anggota{{ $a->id }}" tabindex="-1"
                        ...
                        <div class="modal-dialog">
                            <div class="modal-content">
                                <form action={{ url('/anggota/delete/' . $a->id) }} method="POST">
                                    @csrf
                                    @method('DELETE')
                                    <div class="modal-body">
                                        <center class="mt-3">
                    ...
                    <div class="modal fade" id="update-anggota{{ $a->id }}" tabindex="-1"
                        ...
                        <div class="modal-dialog">
                            <div class="modal-content">
                                ...
                                <form action="{{ url('/admin/anggota/update/' . $a->id) }}" method="POST"
                                    enctype="multipart/form-data">
                                    @csrf
                                    @method('put')
                                    <div class="modal-body">
                            ...
                            <tr>
                                ...
                                <td>
                                    <button type="button" class="btn btn-success" data-bs-toggle="modal"
                                        data-bs-target="#update-anggota{{ $p->id }}">update</button>
                                    <button type="button" class="btn btn-danger" data-bs-toggle="modal"
                                        data-bs-target="#hapus-anggota{{ $p->id }}">delete</button>
                                </td>
                            </tr>
                        @endforeach
                    </tbody>
